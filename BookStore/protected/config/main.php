        ...
        */
        ...
        'urlManager'=>array(
            ...
            'rules'=>array(
                ...
                array('api/banUser', 'pattern'=>'api/banUser/<id:\d+>/<isBan:\d+>', 'verb'=>'PUT'),
                array('api/makeAdmin', 'pattern'=>'api/makeAdmin/<id:\d+>', 'verb'=>'PUT'),
                array('api/checkIfExists', 'pattern'=>'api/checkIfExists/<un:\w+>', 'verb'=>'GET'),
