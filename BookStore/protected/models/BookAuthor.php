...
/**
 * This is the model class for table "tbl_book_author".
 *
 * The followings are the available columns in table 'tbl_book_author':
 * @property integer $id
...
class BookAuthor extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id, author, book', 'required'),
			array('id, author, book', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, author, book', 'safe', 'on'=>'search'),
		);
	}
